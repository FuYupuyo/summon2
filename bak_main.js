...
window.onload = function(){
    ...
    game.onload = function(){
        ...
        function gameOver(){
            ...
            remain.text = "残りHPは"+hp;
            remain.x = 0; remain.y = 100;
            remain.color = 'blue';
            remain.font = '26px "Monaco"';
        ...
        itemLabel.y = 188;
        itemLabel.color = 'red';
        itemLabel.font = '6px "Monaco"';
        itemLabel.text="NEXTを";
        scene.addChild(itemLabel);
        var itemLabel2 = new Label();
        itemLabel2.x = 4;
        itemLabel2.y = 198;
        itemLabel2.color = 'red';
        itemLabel2.font = '6px "Monaco"';
        itemLabel2.text="赤く!";
        ...
        //モンスター表示
        var monster = new Sprite(160,32);
        monster.image = game.assets['monster.png'];
        monster.x = 0; monster.y = 108;
